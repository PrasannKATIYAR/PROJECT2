...
for i=1:10001
 I1(i) = v_ph / sqrt( ( ( r1 + ( (2*r2/s(i)) ) )^2) + (x1+x2 )^2);
end

for i=1:10001
 I2(i) = v_ph / sqrt( ( ( r1 + ( (5*r2/s(i)) ) )^2) + (x1+x2 )^2);
end
...
grid on
hold on
plot(n_m,I1,'c--','linewidth',2),legend('original.rot.res','doubles.rot.res','five.rot.res')
hold on
plot(n_m,I2,'m--','linewidth',2),legend('original.rot.res','double.rot.res','five.rot.res')